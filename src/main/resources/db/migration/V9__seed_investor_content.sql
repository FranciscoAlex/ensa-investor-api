...
-- -----------------------------------------------------------------
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Receita T2 2025', '97.3B', 2025, 2, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('EPS T2 2025', '1.56', 2025, 2, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Margem Bruta T2 2025', '45.2%', 2025, 2, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('YoY T2 2025', '+5%', 2025, 2, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Receita T1 2025', '120.1B', 2025, 1, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('EPS T1 2025', '2.15', 2025, 1, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Margem Bruta T1 2025', '46.0%', 2025, 1, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('YoY T1 2025', '+3%', 2025, 1, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Receita T4 2024', '89.5B', 2024, 4, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('EPS T4 2024', '1.44', 2024, 4, 'QUARTERLY_RESULTS', 'AOA', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('Margem Bruta T4 2024', '44.7%', 2024, 4, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
INSERT INTO business_indicators (title, indicator_value, period_year, period_quarter, category, unit, created_at)
VALUES ('YoY T4 2024', '+2%', 2024, 4, 'QUARTERLY_RESULTS', '%', CURRENT_TIMESTAMP);
...
VALUES (@assembly_id, 'Apreciação do Relatório de Gestão e Contas do exercício de 2024.', 1);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Aprovação da proposta de aplicação dos resultados do exercício de 2024.', 2);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Avaliação geral do desempenho do Conselho de Administração e do Conselho Fiscal.', 3);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Apreciação do Relatório de Governo Societário referente ao ano de 2024.', 4);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Deliberação sobre o Relatório da Comissão de Remunerações.', 5);
...
VALUES (@assembly_id, 2024, 'Convocatória AGO 2024', '#', 'PDF', '1.2 MB', '2025-04-10', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2024, 'Relatório e Contas 2024', '#', 'PDF', '8.4 MB', '2025-04-10', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2024, 'Relatório de Governo Societário 2024', '#', 'PDF', '2.1 MB', '2025-04-10', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2024, 'Acta da Assembleia Geral 2024', '#', 'PDF', '1.2 MB', '2025-04-10', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2024, 'Parecer do Conselho Fiscal 2024', '#', 'PDF', '0.9 MB', '2025-04-10', CURRENT_TIMESTAMP);
...
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Relatório de Gestão e Contas do exercício de 2023.', 1);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Aplicação de Resultados e Dividendos.', 2);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Eleição de novos membros para o Conselho Fiscal.', 3);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Aprovação do Plano Estratégico 2024-2026.', 4);

INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2023, 'Relatório e Contas 2023', '#', 'PDF', '7.8 MB', '2024-04-18', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2023, 'Convocatória AGO 2023', '#', 'PDF', '1.1 MB', '2024-04-18', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2023, 'Acta da Assembleia Geral 2023', '#', 'PDF', '1.5 MB', '2024-04-18', CURRENT_TIMESTAMP);
...
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Eleição dos membros da Mesa da Assembleia Geral.', 1);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Eleição dos membros do Conselho de Administração.', 2);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Eleição dos membros do Conselho Fiscal.', 3);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Fixação da caução a prestar pelos administradores e fiscais.', 4);
INSERT INTO general_assembly_agenda_items (assembly_id, item_text, display_order)
VALUES (@assembly_id, 'Deliberação sobre a Política de Remuneração dos Órgãos Sociais.', 5);

INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2025, 'Convocatória AGE Dez 2025', '#', 'PDF', '1.2 MB', '2025-12-16', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2025, 'Proposta Lista A - Administração', '#', 'PDF', '3.4 MB', '2025-12-16', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2025, 'Proposta Lista B - Administração', '#', 'PDF', '2.8 MB', '2025-12-16', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2025, 'Curriculum Vitae dos Candidatos', '#', 'PDF', '5.1 MB', '2025-12-16', CURRENT_TIMESTAMP);
INSERT INTO general_assembly_documents (assembly_id, assembly_year, title, document_url, document_type, file_size_label, assembly_date, created_at)
VALUES (@assembly_id, 2025, 'Guia de Procedimento de Votação', '#', 'PDF', '0.9 MB', '2025-12-16', CURRENT_TIMESTAMP);
